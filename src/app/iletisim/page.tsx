...
const contactInfo = [
    {
        icon: Phone,
        title: "Telefon",
        details: ["(0262) 335 04 15", "(0262) 335 06 85"],
        action: "Hemen Ara",
        href: "tel:02623350415",
        color: "bg-primary"
    },
    {
        icon: Mail,
        title: "E-Posta",
        details: ["ugurlutanker@hotmail.com.tr"],
        action: "Mail Gönder",
        href: "mailto:ugurlutanker@hotmail.com.tr",
        color: "bg-slate-900"
    },
    {
        icon: MapPin,
        title: "Adres",
        details: ["Sanayi Mh. İzmit San. Sit. 13. Cadde 318. Blok No: 116 İZMİT / KOCAELİ"],
                ...
                <div className="container">
                                    ...
                                    <div className="space-y-4 min-h-[120px]">
                                        ...
                                        <div className="space-y-1">
                                            {info.details.map((detail, dIdx) => (
                                                <p key={dIdx} className="text-slate-600 font-bold leading-relaxed">{detail}</p>
                                            ))}
                                        </div>
                                    </div>
                    ...
                    <div className="mt-24 max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="relative aspect-square lg:aspect-auto h-full min-h-[450px] rounded-[2.5rem] overflow-hidden shadow-2xl bg-slate-100 group">
                            <iframe
                                src="https://maps.google.com/maps?q=Sanayi+Mh.+%C4%B0zmit+San.+Sit.+13.+Cadde+318.+Blok+No:+116+%C4%B0ZM%C4%B0T+/+KOCAEL%C4%B0&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
                            ...
                            <div className="absolute bottom-6 left-6 right-6 pointer-events-none">
                                <div className="glass p-5 rounded-2xl flex items-center justify-between shadow-xl pointer-events-auto">
                                    ...
                                    <Button size="sm" variant="outline" className="text-[10px] font-black tracking-widest h-8 rounded-xl" asChild>
                                        <a href="https://maps.google.com/maps?q=Sanayi+Mh.+%C4%B0zmit+San.+Sit.+13.+Cadde+318.+Blok+No:+116+%C4%B0ZM%C4%B0T+/+KOCAEL%C4%B0" target="_blank">YOL TARİFİ</a>
                                    </Button>
                                </div>
                            </div>
                        </div>
